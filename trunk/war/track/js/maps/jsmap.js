...
function jsmCreatePushPin(rcdNdx, dsNdx, ppNdx, evRcd)
{
	...
	*/
    ...
    if (IS_FLEET) html += "<tr class='infoBoxRow'><td class='infoBoxCell'><button onClick=\"var mydiv = $(document.createElement('div'));$(mydiv).html('<iframe src=\\'http://dcmaster.mydatacom.com/portal/displayRaiseCase.php?job="+evRcd.optDesc[7]+"\\' frameborder=\\'0\\' height=\\'100%\\' width=\\'100%\\' scrolling=\\'auto\\'></iframe>');\$(mydiv).dialog({title:'Raise Trouble Ticket',height:340,width:540,modal:true});\">Raise Trouble Ticket</button></td></tr>";
    html += "</table>";
