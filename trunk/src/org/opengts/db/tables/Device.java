...
//  2011/02/02  David Aldridge
//     -Added lastSnrCalDown
//     -Added lastSnrCalUp
//     -Added lastPowerDbm
//     -Added lastRtt
//     -Added lastReason
    ...
    implements DataTransport
{
  ...
  //public static final String FLD_smsGatewayProps       = "smsGatewayProps";       // SMS gateway properties
    ...
    // last snr cal down
    public static final String FLD_lastSnrCalDown        = "lastSnrCalDown";
    // last snr cal up
    public static final String FLD_lastSnrCalUp          = "lastSnrCalUp";
    // last power in DBM
    public static final String FLD_lastPowerDbm          = "lastPowerDbm";
    // last RTT
	...
	new DBField(FLD_lastSnrCalDown       , Double.TYPE         , DBField.TYPE_DOUBLE      , "Last SNR Down"           , "format=#0.0"),
	new DBField(FLD_lastSnrCalUp         , Double.TYPE         , DBField.TYPE_DOUBLE      , "Last SNR Up"             , "format=#0.0"),
