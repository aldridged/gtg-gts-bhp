...
//     -Modified balloon display
//  2011/02/15  David Aldridge
...
function jsmCreatePushPin(rcdNdx, dsNdx, ppNdx, evRcd)
{
    ...
    var flat   = jsmFormatCoord(lat,true ,3);
    var flon   = jsmFormatCoord(lon,false,3);
	...
	*/
    ...
    if (IS_FLEET) html += "<tr class='infoBoxRow'><td class='infoBoxCell'><button onClick=\"var mydiv = $(document.createElement('div'));$(mydiv).html('<iframe src=\\'/portal/"+evRcd.optDesc[0]+".html\\' frameborder=\\'0\\' height=\\'100%\\' width=\\'100%\\' scrolling=\\'auto\\'></iframe>');\$(mydiv).dialog({title:'Device Cases and Attachments',height:500,width:700,modal:true});\">Device Cases and Attachments</button></td></tr>";
